...
{
    public class StudentService : IStudentService // για το course εμείς
    {
        ...
        public async Task<bool> DeleteStudentAsync(int id)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("{Message}", "Student with id: " + " deleted.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<Course>> GetStudentCoursesAsync(int id)
        {
            ...
            try
            {
                courses = await _unitOfWork.StudentRepository.GetStudentCourseAsync(id);
            }
            catch (Exception ex)
            {
                _logger.LogError("{Message}{Exception}", ex.Message, ex.StackTrace);
